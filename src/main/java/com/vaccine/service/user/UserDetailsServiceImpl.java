...
import com.vaccine.repository.AppUserRepository;
import com.vaccine.repository.UserRoleRepository;
...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String userName) throws UsernameNotFoundException {
        com.vaccine.model.User appUser = this.appUserRepository.findByUserName(userName);
